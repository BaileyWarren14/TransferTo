                ...
                <ul class="list-group list-group-flush">
                    @forelse($drivers as $driver)
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ route('messages.chat_ad', ['type' => 'driver', 'id' => $driver->id]) }}" class="btn btn-sm btn-outline-primary">
                                Chat
                            </a>
                        </li>
                    @empty
                ...
                <ul class="list-group list-group-flush">
                    @forelse($admins as $admin)
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ route('messages.chat_ad', ['type' => 'admin', 'id' => $admin->id]) }}" class="btn btn-sm btn-outline-success">
                                Chat
                            </a>
                        </li>
                    @empty
